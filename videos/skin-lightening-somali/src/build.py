#!/usr/bin/env python3
"""Generate index.html for the Somali skin-lightening explainer from timing.json.
...
beats = {
    "cream": word_time("q", "kareem"),
    "danger": word_time("hidden", "khatar"),
    "label": word_time("hidden", "summadda"),
    "nolabel": word_time("hidden", "qorin"),
    "hg": word_time("mercury", "meerkuri"),
    "kid": word_time("mercury", "kelyaha"),
    "nerve": word_time("mercury", "dareemayaasha"),
    "thin": word_time("steroid", "khafiifin"),
    "zits": word_time("steroid", "finan"),
    "marks": word_time("steroid", "xariijimo"),
    "stop": word_time("rebound", "joojiyo"),
    "dark": word_time("rebound", "madow"),
    "read": word_time("label", "akhri"),
    "avoid": word_time("label", "fogow"),
    "merc": word_time("label", "mercury"),
    "calo": word_time("label", "calomel"),
    "clob": word_time("label", "clobetasol"),
    "rx": word_time("label", "dhakhtar"),
    "list": word_time("nolist", "liiska"),
    "place": word_time("nolist", "meel"),
    "nobuy": word_time("nolist", "ha", exact=True),
    "pretty": word_time("beauty", "qurux"),
    "change": word_time("beauty", "beddelo"),
    "spot": word_time("doctor", "bar", exact=True),
    "derm": word_time("doctor", "dhakhtarka"),
    "spf": word_time("spf", "qorraxda"),
    "daily": word_time("spf", "maalin"),
    "safe": word_time("spf", "ammaan"),
    "share": word_time("cta", "wadaag"),
...
pops = ["kid", "nerve", "thin", "zits", "marks", "merc", "calo", "clob", "list", "place", "spot", "daily", "safe"]
...
for i, k in enumerate(["cream", "danger", "hg", "dark", "nobuy", "pretty", "derm", "spf", "follow"]):
    audio.append(
