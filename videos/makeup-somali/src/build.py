#!/usr/bin/env python3
"""Generate index.html for the Somali makeup-removal explainer from timing.json.
...
beats = {
    "makeup": word_time("q", "qurxin"),
    "sleep": word_time("q", "seexataa"),
    "tired": word_time("tired", "daalan"),
    "off": word_time("tired", "saar"),
    "clog": word_time("pores", "daloolada"),
    "zit": word_time("pores", "finan"),
    "face": word_time("remove", "wejiga"),
    "eyes": word_time("remove", "indhaha"),
    "cleanser": word_time("wash", "nadiifiye"),
    "water": word_time("wash", "biyo"),
    "fingers": word_time("fingers", "farahaaga"),
    "scrub": word_time("fingers", "xoqin"),
    "towel": word_time("pat", "tuwaal"),
    "dry": word_time("pat", "qalaji"),
    "cream": word_time("moist", "kareem"),
    "nopore": word_time("moist", "daloolada"),
    "brushes": word_time("share", "burushyada"),
    "noshare": word_time("share", "wadaagin"),
    "tonight": word_time("cta", "caawa"),
    "care": word_time("cta", "daryeel"),
    "share": word_time("cta", "u", exact=True),
}
...
pops = ["clog", "zit", "face", "eyes", "cleanser", "water", "scrub", "dry", "nopore", "noshare"]
...
for i, k in enumerate(["sleep", "cream", "care", "share"]):
    audio.append(
