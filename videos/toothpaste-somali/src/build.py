#!/usr/bin/env python3
"""Generate index.html for the Somali toothpaste-on-pimples explainer from timing.json.
...
beats = {
    "paste": word_time("q", "cadayga"),
    "pimple": word_time("q", "finanka"),
    "wait": word_time("wait", "sug"),
    "harm": word_time("wait", "dhaawici"),
    "teeth": word_time("teeth", "ilkaha"),
    "notmed": word_time("teeth", "daawo"),
    "dryness": word_time("harm", "qallayl"),
    "itch": word_time("harm", "cuncun"),
    "irritate": word_time("harm", "xanaaqa"),
    "dried": word_time("dry", "qalalo"),
    "notheal": word_time("dry", "bogsanayo"),
    "face": word_time("wash", "wejiga"),
    "cleanser": word_time("wash", "nadiifiye"),
    "med": word_time("treat", "daawo"),
    "label": word_time("treat", "tilmaamaha"),
    "squeeze": word_time("hacks", "tuujin"),
    "social": word_time("hacks", "baraha"),
    "pain": word_time("doctor", "xanuun"),
    "stay": word_time("doctor", "tegin"),
    "derm": word_time("doctor", "dhakhtarka"),
    "brush": word_time("remind", "ilkahaaga"),
    "kind": word_time("remind", "naxariiso"),
...
pops = ["pimple", "teeth", "notmed", "dryness", "itch", "irritate", "notheal", "cleanser", "label", "social", "pain", "stay"]
...
for i, k in enumerate(["wait", "derm", "kind", "follow"]):
    audio.append(
