#!/usr/bin/env python3
"""Generate index.html for the Somali hijab-acne explainer from timing.json.
...
beats = {
    "finan": word_time("q", "finan"),
    "hijab": word_time("q", "xijaabku"),
    "sweat": word_time("cause", "dhidid"),
    "oil": word_time("cause", "saliid"),
    "rub": word_time("cause", "xoqid"),
    "clog": word_time("cause", "xiri", exact=True),
    "fr": word_time("name", "xoqidda"),
    "pr": word_time("name", "cadaadiska"),
    "scarf": word_time("wash", "xijaabka"),
    "wash": word_time("wash", "dhaq", exact=True),
    "days": word_time("wash", "dhowrkii"),
    "breathe": word_time("fabric", "neefsata"),
    "cotton": word_time("fabric", "suufka"),
    "heat": word_time("fabric", "kulaylka"),
    "hair": word_time("dry", "timaha"),
    "wet": word_time("dry", "qoyan"),
    "gentle": word_time("night", "tartiib"),
    "clean": word_time("night", "nadiifi"),
    "line": word_time("night", "xariiqda"),
    "sens": word_time("soap", "xasaasi"),
    "choose": word_time("soap", "dooro"),
    "free": word_time("soap", "caraf"),
    "tight": word_time("tight", "adag"),
    "press": word_time("tight", "cadaadiya"),
    "pretty": word_time("pride", "qurux"),
    "care": word_time("pride", "daryeel"),
...
pops = ["finan", "sweat", "oil", "rub", "clog", "fr", "pr", "days", "cotton", "heat", "gentle", "line", "sens", "free", "press"]
...
for i, k in enumerate(["hijab", "wash", "breathe", "wet", "choose", "tight", "pretty", "follow"]):
    audio.append(
