#!/usr/bin/env python3
"""Generate index.html for the Somali pillowcase explainer from timing.json.
...
beats = {
    "ask": word_time("q", "barkintaada"),
    "night": word_time("rest", "habeen"),
    "hours": word_time("rest", "saacado"),
    "sweat": word_time("buildup", "dhidid"),
    "oil": word_time("buildup", "saliid"),
    "cells": word_time("buildup", "unugyo"),
    "hair": word_time("buildup", "timaha"),
    "wash": word_time("weekly", "dhaq"),
    "week": word_time("weekly", "toddobaadkii"),
    "dirty": word_time("sooner", "wasakhoobo"),
    "swap": word_time("sooner", "beddel"),
    "tag": word_time("care", "tilmaamaha"),
    "dry": word_time("care", "qalaji"),
    "sensitive": word_time("detergent", "xasaasi"),
    "soap": word_time("detergent", "saabuunta"),
    "nofrag": word_time("detergent", "caraf"),
    "nocure": word_time("caveat", "daweeyo"),
    "part": word_time("caveat", "qayb"),
    "second": word_time("spare", "labaad"),
    "easy": word_time("spare", "fududaado"),
    "clean": word_time("cta", "nadiif"),
...
pops = ["sweat", "oil", "cells", "hair", "week", "dirty", "tag", "dry", "nofrag", "second"]
...
for i, k in enumerate(["ask", "swap", "part", "clean", "share"]):
    audio.append(
