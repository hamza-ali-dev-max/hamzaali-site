#!/usr/bin/env python3
"""Generate index.html for the Somali face-washing explainer from timing.json.
...
beats = {
    "hard": word_time("q", "xoog"),
    "scrub": word_time("q", "xoqdaa"),
    "stop": word_time("stop", "jooji"),
    "itch": word_time("stop", "cuncun"),
    "irritate": word_time("stop", "xanaaqa"),
    "force": word_time("gentle", "xoog"),
    "soft": word_time("gentle", "tartiib"),
    "water": word_time("products", "biyo"),
    "cleanser": word_time("products", "nadiifiye"),
    "fingers": word_time("fingers", "farahaaga"),
    "sponge": word_time("fingers", "isbuunyo"),
    "rinse": word_time("rinse", "raaci"),
    "towel": word_time("rinse", "tuwaal"),
    "dry": word_time("rinse", "qalaji"),
    "dryskin": word_time("moist", "qalalan"),
    "cream": word_time("moist", "kareem"),
    "am": word_time("when", "subaxdii"),
    "pm": word_time("when", "habeenkii"),
    "sweat": word_time("when", "dhididdo"),
    "many": word_time("nocure", "badan"),
    "notfix": word_time("nocure", "xal"),
    "kind": word_time("kind", "naxariiso"),
    "care": word_time("kind", "daryeel"),
    "shareit": word_time("cta", "wadaag"),
...
pops = ["itch", "irritate", "soft", "cleanser", "sponge", "dry", "cream", "am", "pm", "sweat", "notfix"]
...
for i, k in enumerate(["stop", "kind", "follow"]):
    audio.append(
