#!/usr/bin/env python3
"""Generate index.html for the Somali makeup-brush cleaning explainer from timing.json.
...
beats = {
    "brushes": word_time("q", "burushyada"),
    "forgot": word_time("time", "xasuusan"),
    "now": word_time("time", "waqtigii"),
    "residue": word_time("buildup", "haraaga"),
    "oil": word_time("buildup", "saliid"),
    "germs": word_time("buildup", "bakteeriya"),
    "seven": word_time("often", "toddobadii"),
    "ten": word_time("often", "tobankii"),
    "water": word_time("shampoo", "biyo"),
    "shampoo": word_time("shampoo", "shaambo"),
    "bristles": word_time("shampoo", "timaha"),
    "rinse": word_time("rinse", "raaci"),
    "clear": word_time("rinse", "nadiif"),
    "squeeze": word_time("towel", "saar"),
    "towel": word_time("towel", "tuwaal"),
    "lay": word_time("flat", "jiifi"),
    "upright": word_time("flat", "taagin"),
    "noshare": word_time("noshare", "wadaagin"),
    "tools": word_time("clean", "qalab"),
...
pops = ["residue", "oil", "germs", "seven", "ten", "shampoo", "clear", "towel", "lay", "upright", "noshare"]
...
for i, k in enumerate(["now", "tools", "follow"]):
    audio.append(
