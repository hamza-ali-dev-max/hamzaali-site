#!/usr/bin/env python3
"""Generate index.html for the Somali body-lotion explainer from timing.json.
...
beats = {
    "face": word_time("q", "wejiga"),
    "ask": word_time("q", "marisaa"),
    "heavy": word_time("careful", "culus"),
    "scent": word_time("careful", "cadarka"),
    "pimples": word_time("react", "finan"),
    "itch": word_time("react", "cuncun"),
    "suits": word_time("choose", "habboon"),
    "nofrag": word_time("choose", "caraf"),
    "pores": word_time("choose", "dalooladana"),
    "notbad": word_time("notbad", "xuma"),
    "yourskin": word_time("notbad", "maqaarkaaga"),
    "read": word_time("cta", "summaddana"),
}
beats["share"] = round(beats["read"] + 0.7, 3)
...
pops = ["heavy", "scent", "pimples", "itch", "suits", "nofrag", "pores"]
...
for i, k in enumerate(["ask", "yourskin", "read"]):
    audio.append(
