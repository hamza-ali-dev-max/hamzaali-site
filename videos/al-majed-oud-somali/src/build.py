#!/usr/bin/env python3
"""Generate index.html for the Somali Al Majed Oud product ad from timing.json.
...
beats = {
    "home": word_time("hook", "gurigaaga"),
    "chips": word_time("what", "jajab"),
    "oil": word_time("what", "saliid"),
    "riyadh": word_time("made", "riyaad"),
    "jar": word_time("made", "quraarad"),
    "lid": word_time("made", "dabool"),
    "coal": word_time("how", "dhuxul"),
    "electric": word_time("how", "dabqaad"),
    "guests": word_time("when", "martidu"),
    "friday": word_time("when", "jimcaha"),
    "eid": word_time("when", "ciidaha"),
    "wedding": word_time("when", "aroosyada"),
    "air": word_time("air", "hawo"),
    "little": word_time("air", "yarna"),
    "clothes": word_time("safe", "dharka"),
    "eyes": word_time("safe", "indhaha"),
    "kids": word_time("safe", "carruurtana"),
    "brand": word_time("cta", "al"),
...
pops = ["chips", "oil", "coal", "electric", "guests", "friday", "eid", "wedding", "clothes", "eyes", "kids"]
...
for i, k in enumerate(["home", "riyadh", "air", "buy"]):
    audio.append(
