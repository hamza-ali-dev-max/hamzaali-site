#!/usr/bin/env python3
"""Generate index.html for the Somali dark-spots explainer from timing.json.
...
beats = {
    "spot": word_time("q", "bar", exact=True),
    "name": word_time("name", "madoobaadka"),
    "pig": word_time("why", "midab"),
    "irr": word_time("why", "xanaaqo"),
    "good": word_time("good", "wanaagsan"),
    "fade": word_time("good", "yaraataa"),
    "squeeze": word_time("nopop", "ha", exact=True),
    "darker": word_time("nopop", "madoojisaa"),
    "spf": word_time("spf", "qorraxda"),
    "daily": word_time("spf", "maalin"),
    "cloudy": word_time("spf", "daruurta"),
    "barta": word_time("sun", "barta"),
    "darken": word_time("sun", "madow"),
    "long": word_time("sun", "muddo"),
    "niac": word_time("ingr", "niacinamide"),
    "azel": word_time("ingr", "azelaic"),
    "retin": word_time("ingr", "retinoid"),
    "help": word_time("ingr", "caawin"),
    "scrub": word_time("avoid", "xoqidda"),
    "bleach": word_time("avoid", "kareemada"),
    "notfade": word_time("doctor", "yaraan"),
...
pops = ["name", "pig", "irr", "fade", "darker", "daily", "cloudy", "darken", "long", "niac", "azel", "retin", "scrub", "bleach", "notfade"]
...
for i, k in enumerate(["spot", "good", "squeeze", "spf", "help", "derm", "follow"]):
    audio.append(
